...
function generateMaterials() {
  return [
    ...
    },
    {
      ...
      description: 'Premium silver alloy with 92.5% silver content for enhanced durability',
      purity: '92.5%',
    ...
    },
    {
      ...
      description: 'Time-tested silver alloy used in traditional South Indian silvercraft',
      purity: '90%+',
  ...
  return [
    {
      ...
      description: 'Timeless plain designs that showcase the natural beauty of silver',
      featured: true,
      publishedAt: new Date().toISOString(),
    },
    {
      ...
      description: 'Exquisite hand-engraved pieces showcasing traditional craftsmanship',
      featured: true,
      publishedAt: new Date().toISOString(),
    },
    {
      ...
      description: 'Precisely crafted designs with consistent machine engraving',
      featured: false,
      publishedAt: new Date().toISOString(),
    },
    {
      ...
      description: 'Traditional serpent motifs representing wisdom and protection',
      featured: true,
      publishedAt: new Date().toISOString(),
    },
    {
      ...
      description: 'Sacred designs featuring the eight forms of Goddess Lakshmi',
      featured: true,
      publishedAt: new Date().toISOString(),
    },
    {
    ...
    },
    {
      ...
      description: 'Sacred pieces designed for religious ceremonies and rituals',
      featured: false,
      publishedAt: new Date().toISOString(),
    },
    {
...
function getProductCollections(name: string): string[] {
  ...
  if (nameLower.includes('hand engraving') || nameLower.includes('hand-engraving')) {
    collections.push('collection-hand-engraved')
  }
  if (nameLower.includes('machine engraving') || nameLower.includes('machine-engraving')) {
...
function getProductMaterial(weightGrams: number, name: string): string {
  ...
  if (weightGrams < 50 || nameLower.includes('coin') || nameLower.includes('bar')) {
...
function generateProducts(csvProducts: CSVProduct[], categories: any[]) {
  ...
  return csvProducts
    .filter(product => product.Category?.trim() && product['Product Name']?.trim())
    .map(product => {
      ...
      return {
        ...
        collections: getProductCollections(cleaned.name).map(collectionId => ({
          _type: 'reference',
          _ref: collectionId
        })),
        images: [
        ...
        available: cleaned.status !== 'remove' && cleaned.status !== 'needs Updation/ checking',
        publishedAt: new Date().toISOString(),
      }
    })
}
