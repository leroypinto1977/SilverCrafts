      ...
      const mockRequests: CustomerRequest[] = [
        {
          ...
          message: 'I would like to inquire about custom engraving services for a family crest on a sterling silver serving tray.',
          status: 'pending',
          priority: 'high',
        ...
        },
        {
          ...
          message: 'We are interested in placing a bulk order for our restaurant. Could you provide pricing for 50 sets of dinner cutlery?',
          status: 'in_progress',
          priority: 'medium',
        ...
        },
        {
          ...
          message: 'Looking for recommendations on a complete silverware set as a wedding gift. What would you suggest for a young couple?',
          status: 'completed',
          priority: 'low',
        ...
        },
        {
          ...
          message: 'We need to purchase silverware for official state dinners. Please provide catalog and pricing for premium collections.',
          status: 'pending',
          priority: 'high',
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-xs text-muted-foreground">{request.customer_email}</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
