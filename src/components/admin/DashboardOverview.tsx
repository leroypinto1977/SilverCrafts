    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          A quick overview of your SilverCrafts business metrics.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border border-gray-200 bg-white">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.pendingRequests}</div>
            <p className="text-xs text-gray-500">
              Awaiting response
            </p>
          </CardContent>
        ...
        <Card className="col-span-4 border border-gray-200 bg-white">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600">
              Latest updates from your SilverCrafts business
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-black">Low stock alert for Sterling Silver Ring</p>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-black">Customer request completed</p>
