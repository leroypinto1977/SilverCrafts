  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 font-sans">
            ...
            SilverCrafts began as a small workshop dedicated to preserving
            traditional South Indian silversmithing techniques.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 font-sans">
            Today, SilverCrafts stands as India's leading B2B silverware
