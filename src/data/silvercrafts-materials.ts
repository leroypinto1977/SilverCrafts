...
export const silverCraftsMaterials = [
  {
    ...
    description:
      "Highest purity silver used for premium religious and ceremonial items.",
    properties: [
  ...
  },
  {
    ...
    description:
      "Standard silver alloy providing excellent durability for daily use items.",
    properties: [
  ...
  },
  {
    ...
    description:
      "Time-tested silver composition used in South Indian silvercraft traditions.",
    properties: [
