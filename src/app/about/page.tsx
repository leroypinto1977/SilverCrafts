        ...
        <section className="py-20 bg-gradient-to-br from-background to-gray-50">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              For over 140 years, SilverCrafts has been synonymous with
              exceptional quality, timeless elegance, and masterful artisanship.
              From our humble beginnings in Antwerp to becoming a globally
              recognized name in luxury silverware.
            </p>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 to-gray-50">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Discover why discerning customers worldwide choose SilverCrafts
